...
#        model.load_state_dict(checkpoint['state_dict'])
    ...
    for name, parameters in model.module.base.named_parameters():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        prune_index_dict, _ = L2_criterion(model=model.module.base, model_adapter=model_adapter)
        ...
        for name, parameters in model.module.base.named_parameters():
            ...
            if layer_index == -1:
                ...
                if param_type == ParameterType.CNN_WEIGHTS:
                    ...
                    conv_tensor = model_adapter.get_layer(model.module.base, param_type, tensor_index, layer_index, block_index)
                    ...
                    bn_tensor = model_adapter.get_layer(model.module.base, param_type, tensor_index, layer_index, block_index)
                    ...
                    fc_tensor = model_adapter.get_layer(model.module.base, param_type, tensor_index, layer_index, block_index)
                    reset_index = reset_indexes[-1]
                ...
                if param_type == ParameterType.CNN_WEIGHTS:
                    ...
                    if tensor_index == 2:
                        ...
                        downsample_cnn, d_name = model_adapter.get_downsample(model.module.base, layer_index, block_index)
    ...
    zero_indexes, remain_indexes = zeroed_criterion(model=model.module.base, model_adapter=model_adapter)
    out_channels_keep_indexes = []
    in_channels_keep_indexes = []
    reset_indexes = []
    first_fc = False
    ...
    for name, parameters in model.module.base.named_parameters():
        ...
        if layer_index == -1:
            ...
            if param_type == ParameterType.CNN_WEIGHTS:
                ...
                model_adapter.set_layer(model.module.base, param_type, new_tensor, tensor_index, layer_index, block_index)
                ...
                n_bn = create_new_bn(bn_tensor, keep_index, [])
                model_adapter.set_layer(model.module.base, param_type, n_bn, tensor_index, layer_index, block_index)
                ...
                model_adapter.set_layer(model.module.base, param_type, new_fc_tensor, tensor_index, layer_index, block_index)
            ...
            if param_type == ParameterType.CNN_WEIGHTS:
                ...
                if tensor_index == 1:
                    only_zero_filters_index = zero_indexes[name]
                    keep_index = remain_indexes[name]
                    conv_tensor = model_adapter.get_layer(model.module.base, param_type, tensor_index, layer_index,
                                                          block_index)
                    original_out_channels = parameters.shape[0]

                    new_tensor = create_conv_tensor(conv_tensor, out_channels_keep_indexes, zero_initializer,
                                                    keep_index, []).cuda()
                    model_adapter.set_layer(model.module.base, param_type, new_tensor, tensor_index, layer_index,
                                            block_index)
                ...
                model_adapter.set_layer(model.module.base, ParameterType.DOWNSAMPLE_WEIGHTS, last_start_conv, tensor_index,
                                        layer_index,
                                        block_index)
