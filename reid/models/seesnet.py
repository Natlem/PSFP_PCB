...
from .senet_pytorch import se_resnet50, se_resnet101
...
class SEResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        if depth not in SEResNet.__factory:
            raise KeyError("Unsupported depth:", depth)
        self.base = SEResNet.__factory[depth](pretrained=pretrained)
...
#================append conv for FCN==============================#
            ...
            out_planes = self.base.last_linear.in_features
...
def seresnet50(**kwargs):
    return SEResNet(50, **kwargs)


def seresnet101(**kwargs):
    return SEResNet(101, **kwargs)
